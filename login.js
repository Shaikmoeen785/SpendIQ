document.addEventListener("DOMContentLoaded", () => {
    ...
    if (loginBtn) {
        loginBtn.addEventListener("click", async () => {
            ...
            try {
                const response = await fetch("https://api.jsonbin.io/v3/qs/68a0d1a8ae596e708fcba180");///1
    ...
    if (signupBtn) {
        signupBtn.addEventListener("click", async () => {
            ...
            try {
                const usersResponse = await fetch("https://api.jsonbin.io/v3/qs/68a0d1a8ae596e708fcba180");//2
                ...
                const signupResponse = await fetch("https://api.jsonbin.io/v3/qs/68a0d1a8ae596e708fcba180", {//3
                    method: "POST",
                    headers: {
